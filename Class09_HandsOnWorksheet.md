...
Here we examine the data from 569 patient samples.
...
I this data-set we have 212 cancer and 357 non-cancer.
...
grep allows you to look for patterns. value argument will either tell
you the names of the positives or not.
...
\#\#Principal ComponentAnalaysis The next step in our analysis is to
perform principal componennt analysis (PCA) on
    wisc.data
...
ˆLoosks like we need to use `scale-=TRUE` here as our data are all over
the shop…
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

``` r
plot(wisc.pr$rotation)
```

![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
\#The first PC satures \`r x$importance\[2, “PC1” \*100’ of the original
...
> Q How many principal components are required to describe at least 70%
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-22-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->

this looks quite awful\!

Lets now try clustering in PCA space

We will take the results of `prcomp()` and build our distance matrix in
PC space rather than from our raw data.
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
lets compare i.e. cross tabulate these results: table(grps,
wisc.df$diagnosis)
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](Class09_HandsOnWorksheet_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
